    ...
    this.bucketForm = this.formBuilder.group({
      ...
      lock_retention_period_days: [
        ...
        [
          ...
          CdValidators.custom('eitherDaysOrYears', () => {
            return (
              self.bucketForm &&
              _.get(self.bucketForm.getRawValue(), 'lock_enabled') &&
              ((self.bucketForm.getValue('lock_retention_period_days') > 0 &&
                self.bucketForm.getValue('lock_retention_period_years') > 0) ||
                (self.bucketForm.getValue('lock_retention_period_days') === 0 &&
                  self.bucketForm.getValue('lock_retention_period_years') === 0))
            );
          })
